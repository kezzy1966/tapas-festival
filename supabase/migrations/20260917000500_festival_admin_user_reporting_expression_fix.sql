-- PostgreSQL treats COALESCE, GREATEST, and LEAST as special expressions, not
-- pg_catalog functions. Keep database objects schema-qualified while using the
-- special-expression syntax required for the existing bounded search logic.
begin;
