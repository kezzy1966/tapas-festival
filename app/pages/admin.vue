...
function editFestival(row: any) { editingFestival.value = row; slugManuallyEdited.value = true; festivalForm.value = { ...row, default_tapa_price: String(row.default_tapa_price) }; tab.value = 'festivals'; }
