...
type Tab = 'dashboard' | 'festivals' | 'establishments' | 'tapas' | 'reports' | 'reviews' | 'users' | 'administrators' | 'resources';
...
function adminTabLabel(value: Tab) { return ({ dashboard: 'Dashboard', festivals: 'Festival', establishments: 'Bars', tapas: 'Tapas', reviews: 'Reviews', users: 'Users', reports: 'Reports', administrators: 'Administrators', resources: 'Resources' } as Record<Tab, string>)[value]; }
