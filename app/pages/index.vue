...
function toggleEstablishment(id: string) {
  if (selectedEstablishmentId.value !== id) {
    selectedEstablishmentId.value = id;
    expandedEstablishments.value[id] = false;
  } else {
